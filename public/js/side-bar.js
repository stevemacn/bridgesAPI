...
$.contactButtons({
  ...
  buttons : {
    ...
    'mybutton':   { class: 'git',      use: true, link: 'http://bridgesuncc.github.io', icon: 'github', title: 'Bridges on git' },
    'phone':      { class: 'phone separated',    use: true, link: '+(704) 687-8579' },
    'email':      { class: 'email',    use: true, link: 'krs@uncc.edu' }
  }
});